...
namespace ServiceContracts.DTO
{
    public class PersonResponse
    {
        ...
        {
            return $"Person ID: {PersonID}, Person Name:{PersonName}, Email:{Email}, Date of birth:{DateOfBirth?.ToString("dd MMM yyy")}, Gender:{Gender}, Country ID: {CountryID}, Country: {Country}, Address:{Address}, Receive News Letters: {ReceiveNewsLetters}";
        }
    ...
    {
        /// <summary>
        /// An extension method to convert an object of person class into PresonResponse class
        /// </summary>
        /// <param name="person">person object to convert</param>
        /// <returns>Returns the converted PersonResponse objects</returns>
        public static PersonResponse ToPersonResponse(this Person person)
        {
            ...
            return new PersonResponse()
            {
                ...
                Age = (person.DateOfBirth != null) ? Math.Round((DateTime.Now - person.DateOfBirth.Value).TotalDays / 365.25) : null, Country = person.Country?.country
            };
